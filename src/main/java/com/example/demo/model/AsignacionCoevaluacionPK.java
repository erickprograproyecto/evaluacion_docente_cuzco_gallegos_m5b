...
public class AsignacionCoevaluacionPK implements Serializable {
    ...
    public String toString() {
        return "com.example.demo.model.AsignacionCoevaluacionPK[ idAsignacion=" + idAsignacion + ", idDocenteEvaluador=" + idDocenteEvaluador + ", idDocenteEvaluado=" + idDocenteEvaluado + " ]";
    }
